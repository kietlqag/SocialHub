      ...
      <header className="sticky top-0 z-20 border-b bg-white/80 backdrop-blur">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-semibold text-slate-900">Social Hub</p>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
        <div className="grid gap-6 lg:grid-cols-[320px,1fr]">
            ...
            <div className="flex flex-col items-center text-center gap-4">
              <div className="relative">
                <Avatar className="w-24 h-24 ring-4 ring-slate-100 shadow-md">
                  ...
                  />
                  <AvatarFallback className="bg-slate-900 text-slate-50 text-2xl">
                    {getInitials(profile.fullName)}
                  </AvatarFallback>
                </Avatar>
                <button
                  type="button"
                  className="absolute bottom-0 right-0 p-2 rounded-full bg-slate-900 text-white shadow-lg hover:bg-slate-800 transition-colors"
                >
          ...
          <Card className="p-6 sm:p-7 border-slate-200 shadow-sm">
            <div className="flex items-center justify-between gap-2 mb-5">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-1">
                  Thông tin này có thể hiển thị cho người dùng khác trong hệ thống.
                </p>
              </div>
              <Button
                onClick={handleSave}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setProfile({
                      ...profile,
                      job_title: (e.target as HTMLInputElement).value,
                    })
                  }
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <Textarea
                  ...
                  placeholder="Viết vài dòng giới thiệu về bản thân, kinh nghiệm, sở thích..."
            ...
            {/* Save button for desktop (đã có ở header form) */}
